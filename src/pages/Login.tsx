            ...
            <div className="h-full">
                <div className="flex flex-wrap items-center justify-center h-full g-6 lg:justify-between">
                    ...
                    <div className="mb-12 md:mb-0 md:w-8/12 lg:w-5/12 xl:w-5/12">
                        <form>
                            <div className="flex flex-row items-center justify-center text-4xl lg:justify-start text-bold"> Login </div>
                            ...
                            <div className="text-center lg:text-left">
                                ...
                                <p className="pt-1 mt-2 mb-0 text-sm font-semibold">
                                    ...
                                    <a href="/register" className="text-red-600 transition duration-150 ease-in-out hover:text-danger-600 focus:text-danger-600 active:text-danger-700">Register</a>
                                </p>
                            </div>
                        </form>
                    </div>
